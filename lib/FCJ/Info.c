...
#line 203 "lib/FCJ/Info.c"

XS_EUPXS(XS_FCJ__Info_get); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_FCJ__Info_get)
{
    dVAR; dXSARGS;
    if (items != 1)
...
;
	SV *	RETVAL;
#line 56 "lib/FCJ/Info.xs"
		RETVAL = fcj_get_info(filename);
#line 217 "lib/FCJ/Info.c"
...
extern "C"
#endif
XS_EXTERNAL(boot_FCJ__Info); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_FCJ__Info)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("FCJ::Info::get", XS_FCJ__Info_get);
#if PERL_VERSION_LE(5, 21, 5)
